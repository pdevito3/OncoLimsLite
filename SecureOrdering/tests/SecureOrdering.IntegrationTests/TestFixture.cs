namespace SecureOrdering.IntegrationTests
{
    ...
    using MassTransit;
    using SecureOrdering.WebApi.Features.Consumers;
    ...
    public class TestFixture
    {
                ...
                .AddInMemoryCollection(new Dictionary<string, string>
                    {
                        ...
                        { "UseInMemoryBus", "true" },
                        { "ConnectionStrings:Ordering", dockerConnectionString }
                    })
        ...
        {
            using (var conn = new NpgsqlConnection(_configuration.GetConnectionString("Ordering")))
            {
