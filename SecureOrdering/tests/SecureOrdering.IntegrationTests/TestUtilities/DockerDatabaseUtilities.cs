...
namespace SecureOrdering.IntegrationTests.TestUtilities
{
    using Docker.DotNet;
    ...
    public static class DockerSqlDatabaseUtilities
    {
        ...
        public const string DB_NAME = "SecureOrdering";
        public const string DB_IMAGE = "postgres";
        public const string DB_IMAGE_TAG = "latest";
        public const string DB_CONTAINER_NAME = "IntegrationTestingContainer_SecureOrdering";
        public const string DB_VOLUME_NAME = "IntegrationTestingVolume_SecureOrdering";
                ...
                var sqlContainer = await dockerClient
                    ...
                    .CreateContainerAsync(new CreateContainerParameters
                    {
                        ...
                        HostConfig = new HostConfig
                        {
                            ...
                            {
                                $"{DB_VOLUME_NAME}:/SecureOrdering_data"
                            }
                        },
                    });
