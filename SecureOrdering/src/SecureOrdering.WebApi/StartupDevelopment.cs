namespace SecureOrdering.WebApi
{
    using Microsoft.AspNetCore.Builder;
    using Microsoft.AspNetCore.Hosting;
    using Microsoft.Extensions.Configuration;
    using Microsoft.Extensions.DependencyInjection;
    using SecureOrdering.Infrastructure;
    using SecureOrdering.Infrastructure.Seeders;
    using SecureOrdering.Infrastructure.Contexts;
    using SecureOrdering.WebApi.Extensions.Services;
    using SecureOrdering.WebApi.Extensions.Application;
    using Serilog;
    ...
    public class StartupDevelopment
    {
        ...
        {
            services.AddCorsService("SecureOrderingCorsPolicy");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseCors("SecureOrderingCorsPolicy");
